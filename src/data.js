export const BRUNCH_MENU_CARD = {
  price: "35",
  includes: ["0,1l Orangensaft", "1× Kaffee-Spezialität", "Bio Eggs Benedict", "Kaiserschmarrn"],
  addon: { name: "Prosecco 0,1l", price: "5" },
};
...
export const BRUNCH_ADDONS = [
  { name: "Gereifter Cheddar", price: "2" },
  { name: "Avocado", price: "3" },
  { name: "Pochiertes Bio-Ei", price: "3" },
  { name: "Bacon", price: "3" },
  { name: "Prosciutto Cotto", price: "4" },
  { name: "Hollandaise", price: "4" },
...
export const BEILAGEN_ITEMS = [
  { name: "Beilagensalat", price: "5" },
  { name: "Pommes Frites", price: "7" },
  { name: "Oliven", price: "4" },
  { name: "Sauerteig & Brioche & Kürbiskernölbutter", price: "6" },
  { name: "Mayo oder Ketchup", price: "1" },
  { name: "Hausgemachte Trüffel-Mayo", price: "4" },
  { name: "Schnittlauch-Mayo oder Sriracha-Mayo", price: "2" },
  { name: "Hausgemachte Preiselbeere oder Kren", price: "2" },
];
...
export const SPARGEL_EXTRAS = [
  { name: "Backhendl", price: "8" },
  { name: "Kochschinken", price: "6" },
  { name: "Hausgebeizter Lachs", price: "7" },
  { name: "Halbe gebackene Avocado", price: "6" },
];
...
export const GETRAENKE_ITEMS = [
  ...
  { name: "Espresso Martini", desc: "Doppelter Ristretto, Vodka, Kahlúa, Tonka", price: "12" },
